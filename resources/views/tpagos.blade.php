...
<div class="col-sm-offset-3 col-sm-6">
    ...
    <div class="panel-heading">
        <h3>Registro de TPago</h3>
    </div>

    <form class="row g-3" action="{{ route('tpagos.store') }}" method="POST">
    	{{ csrf_field() }}
        {{ method_field('POST') }}
        ...
        <div class="form-floating mb-3">
            ...
            <label for="descrip" class="control-label" required>Descripción del Tpago</label>
        </div>
                    ...
                    <table class="table table-striped task-table">
                        ...
                        <tbody>
                            @foreach ($tpagos as $tpago)
                                ...
                                <tr>
                                    <td class="table-text"><div>{{ $tpago->id }}</div></td>
                                    <td class="table-text"><div>{{ $tpago->descrip }}</div></td>
                                    <td class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <form action="{{ url('tpagos/view')}}/{{$tpago->id}}" method="GET">
                                    ...
                                    <td class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <form action="{{ url('tpagos')}}/{{$tpago->id}}/{{('edit')}}" method="POST">
                                    ...
                                    <td class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <form action="{{ url('tpagos')}}/{{$tpago->id}}" method="POST">
