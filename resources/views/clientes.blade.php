                    ...
                    <table class="table table-striped task-table">
                        ...
                        <tbody>
                            @foreach ($clientes as $cliente)
                                <tr>
                                    <td class="table-text"><div>{{ $cliente->id }}</div></td>
                                    <td class="table-text"><div>{{ $cliente->cedula }}</div></td>
                                    <td class="table-text"><div>{{ $cliente->nombre }}</div></td>
                                    <td class="table-text"><div>{{ $cliente->apellido }}</div></td>
                                    <td class="table-text"><div>{{ $cliente->telefono }}</div></td>
                                    <td class="table-text"><div>{{ $cliente->correo }}</div></td>

                                    <td>
                                        <form action="{{ url('clientes/view')}}/{{$cliente->id}}" method="GET">
                                    ...
                                    <td>
                                        <form action="{{ url('clientes')}}/{{$cliente->id}}/{{('edit')}}" method="POST">
