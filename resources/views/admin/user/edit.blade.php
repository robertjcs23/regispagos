@extends('layouts.app',[ 'page_title' => 'Editar Datos de Usuario'])
...
<div class="col-sm-offset-3 col-sm-6">
    ...
    <form action="{{ url('users/edit')}}/{{$user->id}}" method="POST">
    	...
    	<div class="form-group">
    		...
    		<input type="text" name="name" class="form-control" value="{{$user->name}}"  autocomplete="off"autofocus>
    	</div>
    	...
    	<div class="form-group">
            ...
            <a href="{{url('users')}}" class="btn btn-outline-danger" >
